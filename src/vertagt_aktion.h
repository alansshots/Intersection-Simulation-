...
//	    VPushBack()= ...;
	...
	template <class T>
		...
		public:
			...
			//move, denn obj mag unique ptr sein.
	...
	private:
		iterator p_it;  // erase Iterator speichern
...
//		VErase() = ... ;
		...
		void vAusfuehren() override
		{
			VAktion<T>::p_pListe.erase(p_it); //loeschen von objekte aus der liste.
		}
	};
}  // namespace vertagt
